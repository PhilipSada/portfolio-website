        ...
        <div className="header" ref={header}>
            <div className="header__content">
                ...
                <div className="header__right-menu">
                    ...
                    <div className="header__right-menu-item"  id="menuItem4"><Link href={'/'} className="header__menu-link">Resume</Link></div>
            ...
            <div className={`header__mobile-content ${mobileNav && "header__mobile-content--open"}`}>
                <div className="header__mobile-menu">
                    ...
                    <div className="header__mobile-menu-item"><Link href={'/'} className="header__mobile-menu-link">Resume</Link></div>
                </div>
            </div>
        </div>
    )
